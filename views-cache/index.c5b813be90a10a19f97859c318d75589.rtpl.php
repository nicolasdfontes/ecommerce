    	...
    	<div class="block-slider block-slider4">
    		<ul class="" id="bxslider-home4">
    			...
    			<li><img src="/res/site/img/h4-slide2.png" alt="Slide">
    				<div class="caption-group">
    					<h2 class="caption title">buy one, get one<span class="primary"> 50% <strong>off</strong></span></h2>
    			...
    			<li><img src="/res/site/img/h4-slide3.png" alt="Slide">
    				<div class="caption-group">
    					...
    					<h4 class="caption subtitle">touch</h4>
    					<a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
    				</div>
    			</li>
    			<li><img src="/res/site/img/h4-slide4.png" alt="Slide">
    				<div class="caption-group">
    					<h2 class="caption title">Apple<span class="primary"> Store <strong>Ipod</strong></span></h2>
    					<h4 class="caption subtitle">nano</h4>
    					<a class="caption button-radius" href="#"><span class="icon"></span>Comprar</a>
    				</div>
    			</li>
    		</ul>
                        ...
                        <div class="product-carousel">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-carousel-price">
                                    <ins>R$ <?php echo number_format($value1["vlprice"], 2, ',', ' '); ?></ins>
                                </div> 
                            </div>
                            <?php } ?>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="brand-wrapper">
                        <div class="brand-list">
                            ...
                            <img src="/res/site/img/brand2.png" alt="Kanon">
