	                        ...
	                        <div class="col-sm-6">
	                            <div class="product-inner">
	                                ...
	                                <form action="/cart/<?php echo htmlspecialchars( $product["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/add" class="cart">
	                                    <div class="quantity">
	                                        <input type="number" size="2" class="input-text qty text" title="Qty" value="1" name="qty" min="1" step="1">
	                                    </div>
	                                ...
	                                <div role="tabpanel">
	                                    ...
	                                    <div class="tab-content">
	                                        <div role="tabpanel" class="tab-pane fade in active" id="home">
	                                            ...
	                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam tristique, budiam in consequat iaculis, est purus iaculis mauris, imperdiet facilisis ante ligula at nulla. Quisque volutpat nulla risus, id maximus ex aliquet ut. Suspendisse potenti. cenulla varius lectus id turpis dignissim porta. Quisque magna arcu, blandit quis felis vehicula, feugiat gravida diam. Nullam nec turpis ligula. Aliquam quis blandit elit, ac tasodales nisl. Aliquam eget dolor eget elit malesuada aliquet. In varius lorem lorem, semper bibendum lectus lobortis ac.</p>
	                                        ...
	                                        <div role="tabpanel" class="tab-pane fade" id="profile">
	                                            ...
	                                            <div class="submit-review">
	                                                ...
	                                                <p><label for="email">E-mail</label> <input name="email" type="email"></p>
